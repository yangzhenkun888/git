<?php /* Smarty version Smarty-3.1.8, created on 2019-04-03 14:50:35
         compiled from "/usr/local/nginx-1.14/html/www/admin110/themes/default/template/controllers/home/content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20473299375ca4c83b522ee8-56849801%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cdd10e7445983a69b8abed3abf9516c5b76b307' => 
    array (
      0 => '/usr/local/nginx-1.14/html/www/admin110/themes/default/template/controllers/home/content.tpl',
      1 => 1418719289,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20473299375ca4c83b522ee8-56849801',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ca4c83b579185_28344660',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ca4c83b579185_28344660')) {function content_5ca4c83b579185_28344660($_smarty_tpl) {?>
...
<div id="homepage">
	...
	<div id="column_left">
		...
		<?php if ($_smarty_tpl->tpl_vars['upgrade']->value->need_upgrade){?>
			<div class="warning warn" style="margin-bottom:10px;"><h3><?php echo smartyTranslate(array('s'=>'New version of MileBiz is available'),$_smarty_tpl);?>
...
" target="_blank"><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->tpl_vars['upgrade']->value->version_name;?>
	...
	<?php }else{ ?>
		...
		<p>&nbsp;</p>
		<p><?php echo smartyTranslate(array('s'=>'To receive MileBiz update warnings, you need to activate'),$_smarty_tpl);?>
...
://screencasts.milebiz.com/v1.5/screencast.php?iso_lang=<?php echo $_smarty_tpl->tpl_vars['isoUser']->value;?>
" id="screencast_fancybox"><img height="128" width="220" src="../img/admin/preview_fr.jpg" /><span class="mask-player"></span></a>
		</div>
			<div id="video-content">
			<p><?php echo smartyTranslate(array('s'=>'Take part in the e-commerce adventure with MileBiz, the fast, powerful, and customizable e-commerce solution. With more than 275 features, MileBiz will help you create a world of opportunities without limits. Discover the solution that already powers more than 120,000 active stores worldwide!'),$_smarty_tpl);?>
</p>
			</div>
...
">
	...
	<div id="discover_milebiz"><p class="center"><img src="../img/loader.gif" alt="" /><?php echo smartyTranslate(array('s'=>'Loading...'),$_smarty_tpl);?>
</p></div>
